    ...
    <DashboardLayout>
      <div className="space-y-6">
          ...
          <div className="relative z-10">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">{userProfile.description}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-300">Total Tweets</CardTitle>
          ...
          <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-300">Listed</CardTitle>
        ...
        <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700">
          ...
          <CardContent>
            <div className="space-y-4">
              {tweets.map((tweet) => (
                <div key={tweet.id} className="p-4 bg-gray-700/50 rounded-xl border border-gray-600">
                  ...
                  <p className="text-gray-200 mb-4 leading-relaxed">{tweet.text}</p>
